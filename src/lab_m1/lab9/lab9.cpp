...
Texture2D* Lab9::CreateRandomTexture(unsigned int width, unsigned int height)
{
    ...
    // Diferenta este reprezentata in principiu de faptul ca, in cazul folosirii GL_NEAREST, se disting mai bine unitatile/pixelii de culoare,
    // in timp ce in cazul folosirii GL_LINEAR, culorile au tendinta de a se combina, limitele dintre ele nemaifiind clare
